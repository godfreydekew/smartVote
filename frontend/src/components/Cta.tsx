      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl px-8 py-16 md:py-20 text-center border border-gray-100/50 shadow-xl">
            ...
            <motion.p variants={itemVariants} className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              {t('cta.subtitle')}
            </motion.p>
            ...
            <motion.div variants={itemVariants} className="mt-12 text-sm text-gray-500">
              {t('cta.disclaimer')}
            </motion.div>
          </div>
        </motion.div>
