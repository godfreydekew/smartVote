      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              { icon: Shield, text: t('hero.features.tamperProof'), delay: 0.1 },
              { icon: Check, text: t('hero.features.transparent'), delay: 0.2 },
              { icon: Lock, text: t('hero.features.encrypted'), delay: 0.3 },
            ].map((item, index) => (
              <motion.div
                key={item.text}
