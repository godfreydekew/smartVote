...
const ElectionRules: React.FC<ElectionRulesProps> = ({ 
  rules, 
  isActive, 
  isUpcoming 
}) => {
      ...
      <CardContent className="p-4 sm:p-6">
        <ul className="space-y-4">
          {rules.map((rule, index) => (
            <li key={index} className="flex items-start gap-3 p-3 rounded-lg bg-gray-50/50 hover:bg-gray-50 transition-colors duration-200">
