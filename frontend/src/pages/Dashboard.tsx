              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    Manage your platform's elections and monitor activity
                  </p>
                </div>
                <Button asChild className="flex items-center gap-2 bg-gradient-to-r from-vote-blue to-vote-teal hover:opacity-90 transition-opacity">
